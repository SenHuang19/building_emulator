...
"""
This module generates play-in exogenous and/or environmental input signal to the emulator.
"""

function next_signal(y::Dict, occDur::Array{Float64}, occParams::Array{Any}, list_of_zones::Any)
    # generate the exogenous input from the parameters
    # y contains the current values of the measurements.
    # {<measurement_name>:<measurement_value>}
    # u: dict Defines the exogenous input to be used for the next step.
...
function initialize(start_inSec::Int64,simStep_inSec::Int64,list_of_zones::Any)
    # u: dict Defines the initial exogneous input to be used for the next step.
    # {<input_name> : <input_value>}
